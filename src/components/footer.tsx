...
export function Footer() {
  return (
    <footer className="flex flex-col border-t border-border">
      <div className="max-w-wrapper mx-auto mt-4 flex w-full items-start justify-between border-b border-border py-8">
        <div className="space-y-8">
          <div className="max-w-[312px] space-y-4">
            <img src="/logo.svg" />
            <p className="leading-tight text-muted-foreground">
              Conectando mentes criativas, moldando o amanhã, um projeto de cada
              vez.
            </p>
          </div>
        ...
        <div className="flex max-w-[556px] gap-[72px]">
          <div className="flex flex-col">
            <span className="text-lg font-medium leading-none">Plataforma</span>
      ...
      <div className="max-w-wrapper mx-auto flex w-full py-8">
        <span className="text-sm text-zinc-500">
          © {new Date().getFullYear()} DevXperience. Todos os direitos estão
          reservados.
        </span>
      </div>
    </footer>
