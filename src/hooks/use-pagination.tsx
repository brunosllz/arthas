...
export const usePagination = ({
  ...
  const paginationRange = useMemo(() => {
    ...
    */
    ...
    /*
    	Case 4: We can choice three formats to show.
      	Case 4.1: We can show the first index, dots, middleRange, dots and the last page.
        Case 4.2: We can show the first index, dots, middleRange and the last page.
        Case 4.2: We can show the first index, middleRange, dots and the last page.
    */
